    ...
    <div class="min-h-screen">
        ...
        <nav x-data="{ open: false }" class="bg-white border-b border-gray-200">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center">
                        <a href="{{ url('/') }}">
                            <img src="{{ asset('img/logotintaku.jpeg') }}" alt="Logo" class="h-10 w-auto">
                        </a>
                    </div>
                    ...
                    <div class="hidden sm:flex space-x-6 items-center">
                        ...
                        <a href="{{ url('/loginadmin') }}" class="text-gray-700 hover:text-blue-500 font-semibold">Admin</a>
            ...
            <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden px-4 pb-3">
                ...
                <a href="{{ url('/loginadmin') }}" class="block py-2 font-semibold">Admin</a>
